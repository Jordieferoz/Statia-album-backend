<div class="card-body">
    <table id="datable_1" class="table table-bordered table-striped">
      ...
      foreach ($PUBLISHED_POSTS as $photos) {
      ...
      ?>
          <tr>
            <td><?php echo ++$i; ?></td>
            <td><?php echo $photos->category_id; ?></td>
            ...
            <td class="project-actions text-right">
              ...
              <a class="btn btn-danger btn-sm" href="<?php echo site_url('admin/photos/unpublish/'.$photos->id); ?>">
                  Unpublish
              </a>
          </td>
          </tr>
